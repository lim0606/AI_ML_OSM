...
Fc = 0.5*D*Nc*log(pi) - 0.5*D*log(XiSlashNcpXi) + 0.5*etac.*logDetBc ...
     + gamma_multivariate_ln(eta0*0.5,D) - ...
     gamma_multivariate_ln(etac*0.5,D) -gammaln(Nc) - ...
     log(phi0)- 0.5*eta0.*logDetB0;
